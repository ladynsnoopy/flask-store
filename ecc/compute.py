...
curve = EllipticCurve(
    ...
    b=7,
    # Base point.
    g=(85962530555127514220722273936257851847873890368902340700245657434754493381749,41625805165943263276153335914473124244191389364912626239200931847213599397017),
    # Subgroup order.
    n=5471,
    # Subgroup cofactor.
    h=1,
...
def is_on_curve(point):
    ...
    x, y = point
    val = (y * y - x * x * x - curve.a * x - curve.b) % curve.p

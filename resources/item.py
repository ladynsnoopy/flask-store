...
class Item(Resource):
    ...
    parser.add_argument('store_id', type=int, required=True, help="you need a store id")
    @jwt_required()
    def get(self,name):
    ...
    def post(self,name):
        ...
        data = Item.parser.parse_args() # only allow price field to pass through
